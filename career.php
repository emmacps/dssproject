            ...
            <form method="post" action="shs-result.php">
              <div class="form-group row">
                ...
                <select class="form-control" name="">
                  ...
                  <option value="">Gen. Science</option>
                  <option value="">Business</option>
                  <option value="">Gen. Arts</option>
                  <option value="">Visula Arts</option>
              ...
              <div class="form-group">
                ...
                <div class="">
                  <input type="text" class="form-control" name="maths" required>
                </div>
              </div>
              <div class="form-group ">
                <label for="" class="col-form-label">Preferred University to study</label>
                <div class="">
                  <input type="text" class="form-control" name="science" required>
                </div>
              </div>
              <div class="form-group">
